...
const FirstHeader = () => {
  ...
  return (
    <div>
      {scroll ? (
        <div className="w-full h-[60px] flex justify-center items-center shadow-xl duration-300 fixed z-20 bg-white">
          <div className="w-[95%] h-[50px] justify-between items-center flex">
            ...
            <div className="flex w-[18%] justify-between items-center">
              ...
              <div className="px-3 py-4 text-white bg-blue-600">
                Get P.io for Free
              </div>
            </div>
          </div>
        ...
        <div className="w-full h-[60px] flex justify-center items-center hover:shadow-xl duration-300 fixed z-20 bg-white">
          <div className="w-[95%] h-[50px] justify-between items-center flex">
            <div className="w-[50%] h-[50px] flex items-center">
              <div className="font-bold text-[20px]">project.io</div>
              <div className="flex items-center justify-between ml-[50px] w-[100%] font-medium">
