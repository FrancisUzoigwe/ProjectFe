  ...
  return (
    <div className="bg-white w-full h-auto flex justify-center">
      <div className="w-[93%] h-[auto]">
        ...
        <div className="font-semibold text-[30px] mt-[10px]">
          A Productivity powerhouse
        </div>
        <div className="font-medium text-[16px] w-[41%] mt-[20px]">
          Simple, flexible, and powerful. All it takes are boards, lists and
          cards to get a clear view of who' doing what and what needs to be
          gotten done. Learn more in our{" "}
          <span className="underline">guide for getting started</span>
        </div>
              ...
              <div className="flex hover:shadow-xl duration-300 cursor-pointer w-[65%] h-[150px]">
                ...
                <div className="ml-[10px]">
                  ...
                  <div className="mt-[5px]">
                    Project.io boards keep taks organized and work moving
                    foward. In a glance , see everything from "things to do" to
                    "aww yeah, we did it"
                  </div>
                </div>
              </div>
              <div className="flex hover:shadow-xl duration-300 cursor-pointer w-[65%] h-[150px] mt-[50px]">
                ...
                <div className="ml-[10px]">
                  ...
                  <div className="mt-[5px]">
                    ...
                    Doing or Done-or build a workflow custom fit to yorur team's
                    needs. There's no wronf way to project.io
                  </div>
                </div>
              </div>
              <div className="flex hover:shadow-xl duration-300 cursor-pointer w-[65%] h-[150px] mt-[50px]">
                ...
                <div className="ml-[10px]">
                  ...
                  <div className="mt-[5px]">
                    Cards respresent tasks and ideas and hold all the
                    information to get the job done. As you make progress, move
                    cards across lists to show theier status.
                  </div>
                </div>
              </div>
            </div>
